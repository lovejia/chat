...
# See https://github.com/lovejia/chat/rest-auth for details.
...
def index():
    return 'Sample Tinode REST/JSON-RPC authentication service. '+\
        'See <a href="https://github.com/lovejia/chat/rest-auth/">https://github.com/lovejia/chat/rest-auth/</a> for details.'
