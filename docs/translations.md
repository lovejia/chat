...
The translations are located in two places: [/src/i18n/](https://github.com/lovejia/webapp/tree/devel/src/i18n/) and [/service-worker.js](https://github.com/lovejia/webapp/blob/devel/service-worker.js#L11).
...
A single file needs to be translated: [/tinode/tindroid/app/src/main/res/values/strings.xml](https://github.com/lovejia/tindroid/blob/devel/app/src/main/res/values/strings.xml)

Create a new directory `values-XX` in [app/src/main/res](https://github.com/lovejia/tindroid/tree/devel/app/src/main/res), where `XX` is a two-letter [ISO-631-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) code , optionally followed by a two letter [ISO 3166-1-alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) region code (preceded by lowercase r). For example `values-pt.xml` would contain Portuguese translations while `values-pt-rBR.xml` is for _Brazilian_ Portuguese translations.
...
* [/en.lproj/Localizable.strings](https://github.com/lovejia/ios/blob/devel/en.lproj/Localizable.strings)
* [/Tinodios/en.lproj/Main.strings](https://github.com/lovejia/ios/blob/devel/Tinodios/en.lproj/Main.strings)
